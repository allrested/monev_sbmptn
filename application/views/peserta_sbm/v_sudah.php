 ...
 <section class="content-header">
        ...
        <div class="col-md-12">
          <div class="box box-default">
            ...
            <form method="post" action="<?php echo base_url()?>peserta_sbm/update">
            ...
            <textarea class="form-control textarea" name="catatan" placeholder="Catatan lain yang perlu disampaikan:" required><?php echo $value['peserta_sbm_catatan'] ?></textarea>
