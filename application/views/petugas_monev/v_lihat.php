 <section class="content-header">
        ...
        <div class="col-md-12">
          <div class="box box-default">
            ...
            <form method="post" action="<?php echo base_url()?>Petugas_monev/insert">
            <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="radio" name="a3f" value="1"></td>
                        <td align="center"><input type="radio" name="a3f" value="0"></td>
                        <td align="center"><input type="text" name="a3ft" class="form-control"></td>
                    </tr>
                    <tr>
             ...
             <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="c5t" class="form-control"></td>
                    </tr>
                    <tr>
                        ...
                        <td align="center"><input type="text" name="c6t" class="form-control"></td>
                    </tr>
                </tbody>
            </table>
             ...
             <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="radio" name="ae1" value="1"></td>
                        <td align="center"><input type="radio" name="ae1" value="0"></td>
                        <td align="center"><input type="text" name="ae1t" class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Perjokian</td>
                        <td align="center"><input type="radio" name="be1" value="1"></td>
                        <td align="center"><input type="radio" name="be1" value="0"></td>
                        <td align="center"><input type="text" name="be1t" class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Menggunakan peralatan yang dilarang (a.l. Kalkulator/catatan dll)</td>
                        <td align="center"><input type="radio" name="ce1" value="1"></td>
                        <td align="center"><input type="radio" name="ce1" value="0"></td>
                        <td align="center"><input type="text" name="ce1t" class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Kerjasama antar Peserta</td>
                        <td align="center"><input type="radio" name="de1" value="1"></td>
                        <td align="center"><input type="radio" name="de1" value="0"></td>
                        <td align="center"><input type="text" name="de1t" class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Lainnya...</td>
                        <td align="center"><input type="radio" name="ee1" value="1"></td>
                        <td align="center"><input type="radio" name="ee1" value="0"></td>
                        <td align="center"><input type="text" name="ee1t" class="form-control"></td>
                    </tr>
                </tbody>
            </table>
             ...
             <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td>Dosen</td>
                        <td align="center"><input type="number" name="af1" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Guru</td>
                        <td align="center"><input type="number" name="bf1" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Tenaga Kependidikan golongan III</td>
                        <td align="center"><input type="number" name="cf1" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Mahasiswa</td>
                        <td align="center"><input type="number" name="df1" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td align="center">2</td>
                    ...
                    <tr>
                        <td></td>
                        <td>Dosen</td>
                        <td align="center"><input type="number" name="af2" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Guru</td>
                        <td align="center"><input type="number" name="bf2" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Tenaga Kependidikan golongan III</td>
                        <td align="center"><input type="number" name="cf2" required class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>Mahasiswa</td>
                        <td align="center"><input type="number" name="df2" required class="form-control"></td>
                    </tr>
                </tbody>
            </table>
             <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="radio" name="aff1"  value="1" required ></td>
                        <td align="center"><input type="radio" name="aff1" value="0" required ></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>b. Tidak dapat mendengar</td>
                        <td align="center"><input type="radio" name="bff1"  value="1" required ></td>
                        <td align="center"><input type="radio" name="bff1"  value="0" required ></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>c. Tidak dapat berjalan</td>
                        <td align="center"><input type="radio" name="cff1"  value="1" required ></td>
                        <td align="center"><input type="radio" name="cff1"  value="0" required ></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>d. Lainnya</td>
                        <td align="center"><input type="radio" name="dff1"  value="1" required ></td>
                        <td align="center"><input type="radio" name="dff1" value="0"  required ></td>
                    </tr>
                    <tr>
                        <td align="center">2</td>
                        <td>Jika ada, jelaskan tindakan apa yang dilakukan?</td>
                        <td align="center" colspan="2"><input type="text" class="form-control" name="ff2" required ></td>
                    </tr>
                    <tr>
                        <td align="center">3</td>
                        <td>Tanggal berapa pengiriman LJU terisi, BA.U2 dan ABHP ke Pusval.</td>
                        <td align="center" colspan="2">Tanggal <input type="text" class="" name="ff3" required ></td>
                    </tr>
