...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            createProgress: function(filename,filepath,filesize) {},
            ...
            uploadStr:"<i class=\"fa fa-upload\"></i> Upload",
            abortStr: "Batalkan",
            cancelStr: "Tidak Jadi",
            deletelStr: "Hapus",
            doneStr: "Selesai",
            ...
            maxFileCountErrorStr: " Tidak diperbolehkan, karena sudah Terisi: ",
            downloadStr: "Lihat",
	   ...
	   this.startUpload = function () {
        ...
        this.createProgress = function (filename, filepath, filesize, id) {
            ...
            pd.filename.hide();
            // pd.filename.attr('src',filepath);
            filename.path = filepath + filename.filename;
            // $('#id-'+id).val(filepath);
            // filename.inputColumn = inputColumn;
            obj.fileCounter++;
            obj.selectedFiles++;
            if(s.showPreview)
            {
            ...
            if(s.showDownload) {
                pd.download.show();
                pd.download.attr('href', filepath);
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).css('margin', s.previewMargin).appendTo(this.statusbar).hide();
            ...
            // this.download = $("<div class='view-pdf'>" + s.downloadStr + "</div>").appendTo(this.statusbar).hide();
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    if(s.onSubmit.call(this, fileArray) != false) {
                        ...
                        {
                            var sData = serializeData(s.dynamicFormData(obj));
                            if(sData) {
                                for(var j = 0; j < sData.length; j++) {
                                    if(sData[j]) {
